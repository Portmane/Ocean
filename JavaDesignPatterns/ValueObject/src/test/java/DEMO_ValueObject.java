...
public class DEMO_ValueObject {
    public static void main(String[] args) {
        ...
        var instanceOfTheHeroStatClassFourth = instanceOfTheHeroStatClassFirst;                                 /* Fourth instance has the same link on
                                                                                                                * the object as the first instance. */
        System.out.println("Does the first instance equal to second instance ?: " + instanceOfTheHeroStatClassFirst
                .equals(instanceOfTheHeroStatClassSecond));         // First instance is not equal to second.
        ...
        System.out.println("Does the first instance equal to fourth instance ? They are referring on the same cell of memory: " + instanceOfTheHeroStatClassFirst
